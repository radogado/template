...
var scriptSource = (function() { // Get the URL of this script...
...
scriptSourceShort = scriptSource.split('/'); // ...and remove the file name from the URL.
scriptSourceShort.pop();
scriptSourceShort.join('/');

if (typeof customTracker_GetParam == 'undefined') {
	$.getScript( scriptSourceShort + '/rid.js', function () {
